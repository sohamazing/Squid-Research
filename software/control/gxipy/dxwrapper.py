...
if hasattr(dll, "DxRaw8toRGB24"):
    ...
    def dx_raw8_to_rgb24(input_address, output_address, width, height, convert_type, bayer_type, flip):
        ...
        status = dll.DxRaw8toRGB24(
            input_address_p, output_address_p, width_c, height_c, convert_type_c, bayer_type_c, flip_c
        )
        return status
...
if hasattr(dll, "DxRaw16toRaw8"):
    ...
    def dx_raw16_to_raw8(input_address, out_address, width, height, valid_bits):
        ...
        status = dll.DxRaw16toRaw8(input_address_p, out_address_p, width_c, height_c, valid_bits_c)
        return status
...
if hasattr(dll, "DxImageImprovment"):
    ...
    def dx_image_improvement(
        input_address, output_address, width, height, color_correction_param, contrast_lut, gamma_lut
    ):
        """
        ...
        status = dll.DxImageImprovment(
            input_address_p, output_address_p, width_c, height_c, color_correction_param_p, contrast_lut, gamma_lut
        )
        return status
