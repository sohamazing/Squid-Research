...
class GxFeatureID:
    ...
    ENUM_TEST_PATTERN_GENERATOR_SELECTOR = (
        0x300003FA  # The source of test pattern, reference GxTestPatternGeneratorSelectorEntry
    )
    ...
    ENUM_TRANSFER_CONTROL_MODE = (
        0x30000BC9  # The control method for the transfers, Reference GxTransferControlModeEntry
    )
    ENUM_TRANSFER_OPERATION_MODE = (
        0x30000BCA  # The operation method for the transfers, Reference GxTransferOperationModeEntry
    )
