...
Usage: python3 -m control.stitcher.stitcher_process_gui
    ...
    def use_registration_checked(self, checked):
        ...
        if checked:
            ...
            try:
                ...
                temp_params = StitchingParameters(input_folder=self.input_directory)
        ...
        try:
            ...
            params = StitchingParameters(
                ...
                registration_channel=(
                    self.channel_combo.currentText() if self.use_registration_checkbox.isChecked() else ""
                ),
