...
class TUCAM_INIT(Structure):
    _fields_ = [("uiCamCount", c_uint32), ("pstrConfigPath", c_char_p)]  # c_char * 8   c_char_p


# the camera open struct
class TUCAM_OPEN(Structure):
    _fields_ = [("uiIdxOpen", c_uint32), ("hIdxTUCam", c_void_p)]  # ("hIdxTUCam",     c_void_p)
...
class TUCAM_VALUE_INFO(Structure):
    _fields_ = [("nID", c_int32), ("nValue", c_int32), ("pText", c_char_p), ("nTextSize", c_int32)]


# the camera value text struct
class TUCAM_VALUE_TEXT(Structure):
    _fields_ = [("nID", c_int32), ("dbValue", c_double), ("pText", c_char_p), ("nTextSize", c_int32)]
...
class TUCAM_SIZE_ATTR(Structure):
    _fields_ = [("nHOffset", c_int32), ("nVOffset", c_int32), ("nWidth", c_int32), ("nHeight", c_int32)]


class TUCAM_MULTIROI_ATTR(Structure):
    _fields_ = [("bLimit", c_int32), ("nROIStatus", c_int32), ("sizeAttr", TUCAM_SIZE_ATTR)]
...
class TUCAM_BIN_ATTR(Structure):
    _fields_ = [("bEnable", c_int32), ("nMode", c_int32), ("nWidth", c_int32), ("nHeight", c_int32)]
...
class TUCAM_FILE_SAVE(Structure):
    _fields_ = [("nSaveFmt", c_int32), ("pstrSavePath", c_char_p), ("pFrame", POINTER(TUCAM_FRAME))]
...
class TUCAM_VALUEINT(Structure):
    _fields_ = [("nVal", c_int64), ("nMin", c_int64), ("nMax", c_int64), ("nStep", c_int64), ("nDefault", c_int64)]
